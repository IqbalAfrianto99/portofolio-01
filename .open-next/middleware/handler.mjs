...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      let N = Symbol("response"), C = Symbol("passThrough"), T = Symbol("waitUntil");
      class E {
        constructor(e2) {
          this[T] = [], this[C] = false;
        }
      ...
      class q {
        ...
        formatPathname() {
          ...
          return t2 = function(e3, t3, r2, n2) {
            ...
            return !n2 && (j(i2, "/api") || j(i2, "/" + t3.toLowerCase())) ? e3 : A(e3, "/" + t3);
          }((e2 = { basePath: this[B].basePath, buildId: this[B].buildId, defaultLocale: this[B].options.forceLocale ? void 0 : this[B].defaultLocale, locale: this[B].locale, pathname: this[B].url.pathname, trailingSlash: this[B].trailingSlash }).pathname, e2.locale, e2.buildId ? void 0 : e2.defaultLocale, e2.ignorePrefix), (e2.buildId || !e2.trailingSlash) && (t2 = I(t2)), e2.buildId && (t2 = k(A(t2, "/_next/data/" + e2.buildId), "/" === e2.pathname ? "index.json" : ".json")), t2 = A(t2, e2.basePath), !e2.buildId && e2.trailingSlash ? t2.endsWith("/") ? t2 : k(t2, "/") : I(t2);
        }
        formatSearch() {
      ...
      class X extends Response {
        ...
        static redirect(e2, t2) {
          ...
          return i2.set("Location", R(e2)), new X(null, { ...n2, headers: i2, status: r2 });
        }
      ...
      let ej = { keys: (e2) => Array.from(e2.keys()), get: (e2, t2) => e2.get(t2) ?? void 0 }, eD = (e2, t2) => eC().withPropagatedContext(e2.headers, t2, ej), eV = false;
      async function eU(e2) {
        ...
        if ((t2 = await eD(d2, () => "/middleware" === e2.page || "/src/middleware" === e2.page ? eC().trace(f.execute, { spanName: `middleware ${d2.method} ${d2.nextUrl.pathname}`, attributes: { "http.target": d2.nextUrl.pathname, "http.method": d2.method } }, () => eI.wrap(eL, { req: d2, renderOpts: { onUpdateCookies: (e3) => {
          n2 = e3;
        ...
        return { response: h2, waitUntil: Promise.all(c2[T]), fetchMetrics: d2.fetchMetrics };
      }
      async function eB(e2) {
        let t2 = process.env.VERCEL_URL ? `https://${process.env.VERCEL_URL}` : `http://localhost:${process.env.PORT ?? 3e3}`;
        if ("/" === e2.nextUrl.pathname.replace(t2, "").split("?")[0]) return X.redirect(new URL("/home", e2.url));
      }
      r(568), "undefined" == typeof URLPattern || URLPattern;
      let eq = { ...b }, e$ = eq.middleware || eq.default, eG = "/src/middleware";
      if ("function" != typeof e$) throw Error(`The Middleware "${eG}" must export a \`middleware\` or a \`default\` function`);
      function eH(e2) {
        return eU({ ...e2, page: eG, handler: e$ });
      }
    }, 447: (e) => {
      "use strict";
      ...
      (() => {
        var i = { 226: function(i2, a2) {
          !function(o2, s2) {
            "use strict";
            var l = "function", u = "undefined", d = "object", c = "string", p = "major", g = "model", h = "name", f = "type", b = "vendor", m = "version", v = "architecture", w = "console", _ = "mobile", y = "tablet", x = "smarttv", S = "wearable", P = "embedded", O = "Amazon", R = "Apple", N = "ASUS", C = "BlackBerry", T = "Browser", E = "Chrome", M = "Firefox", I = "Google", L = "Huawei", A = "Microsoft", k = "Motorola", j = "Opera", D = "Samsung", V = "Sharp", U = "Sony", B = "Xiaomi", q = "Zebra", $ = "Facebook", G = "Chromium OS", H = "Mac OS", F = function(e2, t2) {
              var r2 = {};
